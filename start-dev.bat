...
start "Backend Server" cmd /k "venv\Scripts\activate && echo ✅ Backend virtual environment activated && echo 🌐 Starting FastAPI server on http://localhost:8001 && python -m uvicorn main:app --reload --port 8001"
...
start "Frontend Server" cmd /k "echo 🌐 Starting React development server on http://localhost:3001 && npm start"
